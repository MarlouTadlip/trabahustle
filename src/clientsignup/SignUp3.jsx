  ...
  return (
    <DndProvider backend={HTML5Backend}>
      ...
      <div className="w-full bg-gray-200 rounded-full h-1.5 mb-4 dark:bg-gray-700">
        <div className="bg-[#00B676] h-1.5 rounded-full dark:bg-blue-500" style={{ width: '50%' }}></div>
      </div>
      <div className="flex justify-between mt-8 pl-7 pr-7 pb-7">
        ...
        <NavLink to="/signup-freelancer-3" className="bg-[#418B71] text-white rounded-md px-10 py-2">
